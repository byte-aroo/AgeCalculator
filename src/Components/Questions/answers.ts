  ...
  if (shoulderAnswers) {
    if (shoulderAnswers[0]) {
      if (shoulderAnswers[0] === "Not appeared") {
        ...
        if (Number(ranges["mukherjeeMax"]) < 19) {
          ranges["mukherjeeMax"] = 19;
        }
        if (Number(ranges["reddyMax"]) < 19) {
          ranges["reddyMax"] = 19;
        }
        if (Number(ranges["swapnilMax"]) < 19) {
    ...
    if (shoulderAnswers[1]) {
      if (shoulderAnswers[1] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 1) {
          ranges["agarwalMax"] = 1;
        }
        if (Number(ranges["mukherjeeMax"]) < 11) {
          ranges["mukherjeeMax"] = 11;
        }
        if (Number(ranges["reddyMax"]) < 11) {
          ranges["reddyMax"] = 11;
        }
        if (Number(ranges["swapnilMax"]) < 11) {
    ...
    if (shoulderAnswers[2]) {
      if (shoulderAnswers[2] === "Not appeared") {
        ...
        if (Number(ranges["reddyMax"]) < 15) {
          ranges["reddyMax"] = 15;
        }
        if (Number(ranges["swapnilMax"]) < 14) {
        ...
        if (Number(ranges["agarwalMax"]) < 20) {
    ...
    if (shoulderAnswers[3]) {
      if (shoulderAnswers[3] === "Not appeared") {
        ...
        if (Number(ranges["mukherjeeMax"]) < 1) {
          ranges["mukherjeeMax"] = 1;
        }
        if (Number(ranges["reddyMax"]) < 1) {
          ranges["reddyMax"] = 1;
        }
        if (Number(ranges["swapnilMax"]) < 1) {
          ranges["swapnilMax"] = 1;
        }
    ...
    if (shoulderAnswers[4]) {
      if (shoulderAnswers[4] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 3) {
          ranges["agarwalMax"] = 3;
        }

        if (Number(ranges["reddyMax"]) < 3) {
          ranges["reddyMax"] = 3;
        }
        if (Number(ranges["swapnilMax"]) < 3) {
          ranges["swapnilMax"] = 3;
        }
        ...
        if (Number(ranges["mukherjeeMax"]) < 4) {
    ...
    if (shoulderAnswers[5]) {
      if (shoulderAnswers[5] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 5) {
          ranges["agarwalMax"] = 5;
        }

        if (Number(ranges["reddyMax"]) < 5) {
          ranges["reddyMax"] = 5;
        }
        if (Number(ranges["swapnilMax"]) < 5) {
          ranges["swapnilMax"] = 5;
        ...
        if (Number(ranges["mukherjeeMax"]) < 7) {
  ...
  if (elbowAnswers) {
    if (elbowAnswers[0]) {
      if (elbowAnswers[0] === "Not appeared") {
        ...
        if (Number(ranges["mukherjeeMax"]) < 8) {
        ...
        if (Number(ranges["reddyMax"]) < 17) {
          ranges["reddyMax"] = 17;
        }
        if (!ranges["swapnilMin"] || Number(ranges["swapnilMin"]) > 5) {
          ranges["swapnilMin"] = 5;
        }
        if (Number(ranges["swapnilMax"]) < 17) {
    ...
    if (elbowAnswers[1]) {
      if (elbowAnswers[1] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 9) {
          ranges["agarwalMax"] = 9;
        }
        if (Number(ranges["mukherjeeMax"]) < 13) {
          ranges["mukherjeeMax"] = 13;
        }
        if (Number(ranges["reddyMax"]) < 9) {
          ranges["reddyMax"] = 9;
        }
        if (Number(ranges["swapnilMax"]) < 9) {
          ranges["swapnilMax"] = 9;
        }
    ...
    if (elbowAnswers[2]) {
      if (elbowAnswers[2] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 7) {
          ranges["agarwalMax"] = 7;
        }
        if (Number(ranges["mukherjeeMax"]) < 7) {
          ranges["mukherjeeMax"] = 7;
        }
        if (Number(ranges["reddyMax"]) < 7) {
          ranges["reddyMax"] = 7;
        }
        if (Number(ranges["swapnilMax"]) < 7) {
          ranges["swapnilMax"] = 7;
        }
    ...
    if (elbowAnswers[3]) {
      if (elbowAnswers[3] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 11) {
        ...
        if (Number(ranges["mukherjeeMax"]) < 15) {
    ...
    if (elbowAnswers[4]) {
      if (elbowAnswers[4] === "Not appeared") {
        ...
        if (Number(ranges["mukherjeeMax"]) < 12) {
  ...
  if (kneeAnswers) {
    if (kneeAnswers[0]) {
      if (kneeAnswers[0] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 0.9) {
          ranges["agarwalMax"] = 0.9;
        }
        if (Number(ranges["mukherjeeMax"]) < 0) {
          ranges["mukherjeeMax"] = 0;
        }
        if (Number(ranges["reddyMax"]) < 0.9) {
          ranges["reddyMax"] = 0.9;
        }
        if (Number(ranges["swapnilMax"]) < 0.9) {
        ...
        if (Number(ranges["agarwalMax"]) < 18) {
    ...
    if (kneeAnswers[2]) {
      if (kneeAnswers[2] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 4) {
          ranges["agarwalMax"] = 4;
        }

        if (Number(ranges["reddyMax"]) < 4) {
          ranges["reddyMax"] = 4;
        }
        if (Number(ranges["swapnilMax"]) < 4) {
          ranges["swapnilMax"] = 4;
        }
  ...
  if (wristAnswers) {
    if (wristAnswers[0]) {
      if (wristAnswers[0] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 2) {
          ranges["agarwalMax"] = 2;
        }
        if (Number(ranges["mukherjeeMax"]) < 1) {
          ranges["mukherjeeMax"] = 1;
        }
        if (Number(ranges["reddyMax"]) < 2) {
          ranges["reddyMax"] = 2;
        }
        if (Number(ranges["swapnilMax"]) < 2) {
          ranges["swapnilMax"] = 2;
        }
        ...
        if (Number(ranges["mukherjeeMax"]) < 20) {
  ...
  if (hipAnswers) {
    if (hipAnswers[0]) {
      if (hipAnswers[0] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 14) {
          ranges["agarwalMax"] = 14;
        }
        if (Number(ranges["mukherjeeMax"]) < 17) {
          ranges["mukherjeeMax"] = 17;
        }
        if (Number(ranges["reddyMax"]) < 14) {
          ranges["reddyMax"] = 14;
        }
        if (Number(ranges["swapnilMax"]) < 14) {
          ranges["swapnilMax"] = 14;
        ...
        if (Number(ranges["reddyMax"]) < 21) {
          ranges["reddyMax"] = 21;
        }
        if (!ranges["swapnilMin"] || Number(ranges["swapnilMin"]) > 14) {
          ranges["swapnilMin"] = 14;
        }
        if (Number(ranges["swapnilMax"]) < 20) {
    ...
    if (hipAnswers[1]) {
      if (hipAnswers[1] === "Not appeared") {
        ...
        if (Number(ranges["swapnilMax"]) < 21) {
    ...
    if (hipAnswers[2]) {
      if (hipAnswers[2] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 13) {
          ranges["agarwalMax"] = 13;
        }

        if (Number(ranges["reddyMax"]) < 13) {
          ranges["reddyMax"] = 13;
        }
    ...
    if (hipAnswers[3]) {
      if (hipAnswers[3] === "Not appeared") {
        ...
        if (Number(ranges["agarwalMax"]) < 17) {
  ...
  if (ankleAnswers) {
    ...
    if (ankleAnswers[2]) {
      if (ankleAnswers[2] === "Not appeared") {
        if (Number(ranges["agarwalMax"]) < 0.5) {
          ranges["agarwalMax"] = 0.5;
        }
        if (Number(ranges["mukherjeeMax"]) < 0) {
          ranges["mukherjeeMax"] = 0;
        }
        if (Number(ranges["reddyMax"]) < 0.5) {
          ranges["reddyMax"] = 0.5;
        }
        if (Number(ranges["swapnilMax"]) < 0.5) {
